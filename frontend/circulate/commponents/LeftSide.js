...
const LestSide = () => {
    ...
    return (
        ...
        <div
            className="bg-white  shadow-[0_2px_15px_-6px_rgba(0,0,0,0.2)] p-8 w-full max-w-sm rounded-lg font-[sans-serif] overflow-hidden mx-auto ">
            <div className=" p-8 flex-col items-center">
                <div className="flex justify-center w-auto h-auto">
                    <img src='https://readymadeui.com/profile_2.webp' className="w-24 h-24 rounded-full" />
                </div>
                <div className="mt-4 text-center">
                    <p className="text-xl text-[#333] font-extrabold">John Doe</p>
                    <p className="text-sm text-gray-500 mt-2">Marketing Coordinator</p>
                </div>
            </div>
            <div className="mt-8 flex justify-between">
                <div className="bg-gray-100 hover:bg-gray-200 w-12 h-12 p-3 flex items-center justify-center rounded-full cursor-pointer">
